...
| Kpi               | `ui/Kpi/kpi.styles.ts`                                     | `src/components/ui/Kpi/`               | ✅ implementado — primitivos composáveis de KPI: `Kpi` (card: label+ícone(tone)+valor+delta+hint+slot sparkline+footnote) · `KpiGroup` (layout columns/divided) · `KpiDelta` (pílula de variação sobre o Chip). Doc viva `#/kpi` (Primitivos + API + Composições/9 modelos). Theme-aware                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
