...
import {
  ...
  type LicencaStatus,
  type KpiCard,
} from "./seguros-licenciados-mock";

const sparkCfg = {
  v: { label: "Corretores", color: "var(--color-chart-3)" },
...
export function SegurosLicenciadosPage() {
        ...
        return (
          <div className="flex w-full items-center gap-gp-xl">
            ...
            <div className="hidden items-center gap-gp-6xl sm:flex">
              <MiniStat
                icon={<ShieldCheck />}
                value={num(row.apolices)}
                label="Apólices"
                iconClass="bg-bg-success-muted text-fg-success"
              />
              <MiniStat
                icon={<Wallet />}
                value={brl(row.premioMensal)}
                label="Prêmio"
  ...
  return (
    <div className="flex flex-col gap-gp-2xl">
      <PageHeader
        title="Licenciados"
        description="Corretores licenciados por status de licença, validade e carteira."
