...
export function LicenciadosPage() {
  ...
  return (
    <div className="flex flex-col gap-gp-2xl">
      <PageHeader
        title="Licenciados"
        description="Base de licenciados Green por status de licença, validade e carteira."
      ...
      <DataTable<LicenciadoRow>
        ...
        columns={columns}
        getRowId={(r) => r.id}
        persistId="licenciados-green-v2"
