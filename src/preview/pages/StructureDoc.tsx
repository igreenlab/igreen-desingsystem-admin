    ...
    <DocLayout toc={TOC}>
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="rounded-radius-base border border-border-subtle p-pad-4xl font-mono text-code-sm text-fg-muted leading-loose">
          ...
          <p className="ml-sp-2xl">status/lessons.md                <span className="text-fg-subtle">← Lessons L-001..L-072</span></p>
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <FileRow path=".ai/status/lessons.md" desc="Canonical L-001..L-072 (full descriptions, examples)" tag="Lessons" />
