      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="grid grid-cols-2 gap-gp-2xl">
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-sm">Cross-agent</p>
            <p className="text-paragraph-sm text-fg-muted">
              Applies to every agent in the project. Designer, Dev, Reviewer e Orchestrator falam com o mesmo formato.
            </p>
          </div>
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-sm">One active at a time</p>
            <p className="text-paragraph-sm text-fg-muted">
...
- Headings só quando há 3+ tópicos distintos.`}</pre>
        ...
        <div className="flex items-center gap-gp-md">
          ...
          <span className="text-paragraph-sm text-fg-muted">Carregado por <code className="font-mono text-code-sm">settings.json</code> em toda sessão.</span>
        </div>
      </div>
  ...
  "outputStyle": "terse"
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="grid grid-cols-2 gap-gp-3xl">
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-md">Bons usos</p>
          ...
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-md">Maus usos</p>
            <ul className="list-disc pl-sp-md flex flex-col gap-gp-sm text-paragraph-sm text-fg-muted">
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="rounded-radius-base border border-border-subtle overflow-hidden">
          <div className="grid grid-cols-[180px_1fr] gap-0 border-b border-border-subtle bg-bg-subtle">
            <div className="py-pad-md px-pad-xl text-label-xs text-fg-default font-medium">Layer</div>
            <div className="py-pad-md px-pad-xl text-label-xs text-fg-default font-medium">Responsibility</div>
          </div>
          <div className="grid grid-cols-[180px_1fr] border-b border-border-subtle">
            <div className="py-pad-md px-pad-xl text-label-sm text-fg-default font-semibold">Output Style</div>
            <div className="py-pad-md px-pad-xl text-paragraph-sm text-fg-muted">Como falar — tom, densidade, formato</div>
          </div>
          <div className="grid grid-cols-[180px_1fr] border-b border-border-subtle">
            <div className="py-pad-md px-pad-xl text-label-sm text-fg-default font-semibold">Agent System Prompt</div>
            <div className="py-pad-md px-pad-xl text-paragraph-sm text-fg-muted">Quem é o agente — papel, escopo, signals</div>
          </div>
          <div className="grid grid-cols-[180px_1fr] border-b border-border-subtle">
            <div className="py-pad-md px-pad-xl text-label-sm text-fg-default font-semibold">Rules</div>
            <div className="py-pad-md px-pad-xl text-paragraph-sm text-fg-muted">Constraints cross-cutting — anti-patterns, lessons</div>
          </div>
          <div className="grid grid-cols-[180px_1fr]">
            <div className="py-pad-md px-pad-xl text-label-sm text-fg-default font-semibold">Skills</div>
            <div className="py-pad-md px-pad-xl text-paragraph-sm text-fg-muted">Como executar uma tarefa específica</div>
          </div>
        </div>
      </div>
    </DocLayout>
