      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="grid grid-cols-2 gap-gp-2xl">
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-xs">Token Specification</p>
            <p className="text-paragraph-sm text-fg-muted">
          ...
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl">
            <p className="text-label-sm text-fg-default mb-gp-xs">Component Specs</p>
            <p className="text-paragraph-sm text-fg-muted">
          ...
          <div className="rounded-radius-base border border-border-subtle p-pad-3xl col-span-2">
            <p className="text-label-sm text-fg-default mb-gp-xs">Figma Extraction</p>
            <p className="text-paragraph-sm text-fg-muted">
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        ...
        <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
          <div className="flex items-start gap-gp-3xl py-pad-xl border-b border-border-subtle">
            <span className="text-label-xs text-fg-muted w-[120px] shrink-0 uppercase tracking-wider">primary</span>
            <span className="text-paragraph-sm text-fg-default">
              Brand color. NOT "main text" — that is fg.foreground.
            </span>
          </div>
          <div className="flex items-start gap-gp-3xl py-pad-xl border-b border-border-subtle">
            <span className="text-label-xs text-fg-muted w-[120px] shrink-0 uppercase tracking-wider">fg.foreground</span>
            <span className="text-paragraph-sm text-fg-default">
              Default text color (neutral). The base foreground for all body text.
            </span>
          </div>
          <div className="flex items-start gap-gp-3xl py-pad-xl border-b border-border-subtle">
            <span className="text-label-xs text-fg-muted w-[120px] shrink-0 uppercase tracking-wider">critical</span>
            <span className="text-paragraph-sm text-fg-default">
              Destructive / error feedback. Never use "danger" or "error" as token names.
            </span>
          </div>
          <div className="flex items-start gap-gp-3xl py-pad-xl border-b border-border-subtle">
            <span className="text-label-xs text-fg-muted w-[120px] shrink-0 uppercase tracking-wider">ring.*</span>
            <span className="text-paragraph-sm text-fg-default">
          ...
          <div className="flex items-start gap-gp-3xl py-pad-xl">
            <span className="text-label-xs text-fg-muted w-[120px] shrink-0 uppercase tracking-wider">on-*</span>
            <span className="text-paragraph-sm text-fg-default">
        ...
        <div className="grid grid-cols-2 gap-gp-2xl">
          ...
          <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
            <div className="flex items-center gap-gp-xl mb-gp-2xl">
              <span
                className="inline-flex items-center justify-center size-icon-lg rounded-radius-sm text-label-xs font-bold text-white"
                style={{ backgroundColor: ACCENT }}
              >
                1
              </span>
              <p className="text-label-sm text-fg-default">New Color</p>
            </div>
            <div className="flex flex-col gap-gp-xl text-paragraph-sm text-fg-muted">
          ...
          <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
            <div className="flex items-center gap-gp-xl mb-gp-2xl">
              ...
              <p className="text-label-sm text-fg-default">New Dimensional Token</p>
            </div>
            <div className="flex flex-col gap-gp-xl text-paragraph-sm text-fg-muted">
          ...
          <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
            <div className="flex items-center gap-gp-xl mb-gp-2xl">
              ...
              <p className="text-label-sm text-fg-default">Component Spec</p>
            </div>
            <div className="flex flex-col gap-gp-xl text-paragraph-sm text-fg-muted">
          ...
          <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
            <div className="flex items-center gap-gp-xl mb-gp-2xl">
              ...
              <p className="text-label-sm text-fg-default">Figma Extraction</p>
            </div>
            <div className="flex flex-col gap-gp-xl text-paragraph-sm text-fg-muted">
          ...
          <table className="w-full">
            <tbody>
              <tr className="border-b border-border-subtle">
                ...
                <td className="text-paragraph-sm text-fg-default py-pad-md px-pad-xl">Task delegation from Orchestrator</td>
              </tr>
              <tr className="border-b border-border-subtle">
                <td className="text-label-xs text-fg-muted font-medium uppercase tracking-wider py-pad-md px-pad-xl">Output</td>
                <td className="text-paragraph-sm py-pad-md px-pad-xl"><code className="font-mono text-code-sm text-fg-brand">SPEC_PRONTA: [name]</code></td>
              </tr>
              <tr>
