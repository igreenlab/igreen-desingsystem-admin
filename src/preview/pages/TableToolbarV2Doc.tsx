...
export function TableToolbarV2Doc() {
  ...
  return (
    <DocLayout
      toc={[
        ...
        { id: "ex-full", label: "Toolbar v2 (drill-down)" },
      ]}
    >
      <DocHeader
        category="Tables"
        title="Table Toolbar v2"
        description="Proposta v2 com layout **opinativo** e a direita simplificada em 3 controles: **Busca**, **Filtros** (funil → drawer simples) e **Configurações** (sliders → menu drill-down com Ordenação · Colunas · Filtros avançados · Densidade), além de **Refresh** e **⋯** (export + ações). Esquerda mantém Kanban/Lista · Abas · Adicionar. Mesmas funções da v1 — só muda a forma de exibir."
      />
      <DocSeparator />
      ...
      <ExampleSection
        id="ex-full"
        title="Toolbar v2 — busca · filtros · configurações"
