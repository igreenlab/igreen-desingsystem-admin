...
export function BreadcrumbSwitcherDoc() {
  ...
  return (
    <DocLayout toc={TOC}>
      <DocHeader
        ...
        description="O item do caminho que troca o registro aberto: o nome do que está aberto vira gatilho e abre uma lista com busca. É o seletor de repositório do GitHub aplicado a cliente, UC, contrato — qualquer coisa de que existam muitos."
      />
      <DocSeparator />

      <SectionH2 id="quando" title="Quando usar" />
