    ...
    <DocLayout toc={TOC}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-gp-2xl">
          {[
            ...
            <div key={a.name} className="rounded-radius-base border border-border-subtle p-pad-3xl">
              <p className="text-label-sm text-fg-default mb-gp-sm">{a.name}</p>
      ...
      <div className="flex flex-col gap-gp-2xl mb-14">
        <div className="flex items-center gap-gp-xl">
          ...
          <span className="text-paragraph-sm text-fg-muted">Token architecture, 3-tier hierarchy and transform pipeline</span>
        </div>
        <div className="flex items-center gap-gp-xl">
          <Badge color="success" variant="soft" size="md">Stable</Badge>
        ...
        <div className="flex items-center gap-gp-xl">
          <Badge color="success" variant="soft" size="md">Stable</Badge>
          <span className="text-paragraph-sm text-fg-muted">AI pipeline (4 agents) + skills + hooks + output style + memory</span>
        </div>
        <div className="flex items-center gap-gp-xl">
