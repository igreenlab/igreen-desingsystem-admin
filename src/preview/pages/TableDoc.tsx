...
// As fixtures moraram aqui até 2026-07-29. Saíram pra `./_table-data` porque o
// `ClientesShowcase` as importa e ELE entra no pacote npm, enquanto esta Doc page é
// excluída da emissão de tipos — os `.d.ts` do showcase apontavam pra cá e não
// resolviam (L-017, pego pelo `npm run lib:verify`). Reexportadas pra não quebrar
// nada que importe daqui.
import {
  STATUSES,
  CATEGORIES,
  AGENTS,
...
export { STATUSES, CATEGORIES, AGENTS, type CategoryKind, type ClientRow };

import { CLIENTS_MOCK } from "./_table-data";
