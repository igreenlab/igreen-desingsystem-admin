...
const CATALOG: CompGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Scheduler", href: "scheduler", desc: "Calendário de eventos (mês, semana, dia, lista)", icon: CalendarClock },
      { name: "Gantt", href: "gantt", desc: "Cronograma de projeto com vínculos entre tarefas", icon: GitBranch },
