        ...
        <div className="rounded-radius-base border border-border-subtle bg-bg-surface shadow-sh-sm p-pad-4xl">
          <div className="font-mono text-code-sm leading-loose">
            {[
              ...
              { depth: 1, name: "status/lessons.md", isDir: false, desc: "Error log — 69 lessons (64 active + 5 archived once absorbed into a gate)" },
              ...
              { depth: 2, name: "tokens/motion.md", desc: "Duration, easing, motion presets" },
              { depth: 2, name: "components/guide.md", desc: "Component creation patterns (tv, variants)" },
              { depth: 2, name: "components/inventory.md", desc: "Component inventory — Regra 2 consults it before creating" },
              { depth: 2, name: "components/chart-patterns.md", desc: "Recharts 3 recipes + the caveats of L-032" },
              { depth: 2, name: "components/dashboard-patterns.md", desc: "Dashboard/KPI-group recipes (L-055)" },
              { depth: 2, name: "components/shadcn-token-map.md", desc: "Shadcn CSS var → DS token mapping" },
