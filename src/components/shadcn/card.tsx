...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex flex-col gap-gp-4xl rounded-radius-base bg-bg-surface py-pad-4xl text-paragraph-sm text-fg-default shadow-sh-lg ring-1 ring-foreground/5 dark:ring-foreground/10",
      className
    )}
    {...props}
  />
